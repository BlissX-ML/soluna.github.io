...
import PdfPageNumber from './PdfPageNumber.jsx';


export default function PdfDocument({ src, slot }) {
    ...
    return (
        <>
            <div className={classes.fileContainer}>
                <Document
                    file={src}
                    loading={<ContentPlaceholder progress={progress} state={section.active} />}

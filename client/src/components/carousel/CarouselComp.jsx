...
import ImagesLoad from '../image/ImagesLoad.jsx';
import ArrowPrevPage from '../icons/ArrowPrevPage.jsx';
import ArrowNextPage from '../icons/ArrowNextPage.jsx';

export default function CarouselComp({ className }) {
    const {
        slideItems,
        curImageInd,
        withTrans,

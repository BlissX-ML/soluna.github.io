...
import Select from "../../features/home-page/quick-links.jsx";
        ...
        <div className={classes.welcome} ref={container}>
            ...
            <div className={classes.recommend}>
                ...
                <div className={classes.btns}>
                    <Select src="/plans">计划表查阅</Select>

                    <Select src="/memo">面试手册查阅</Select>

                    <Select src="/repository">知识库查阅</Select>

                    <Select src="/footprint">足迹查阅</Select>
                </div>
            </div>
        </div>
    );
